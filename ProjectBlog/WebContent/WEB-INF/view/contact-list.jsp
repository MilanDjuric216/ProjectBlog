	                    ...
	                    <tr>
	                      ...
	                      <td class="text-center">
	                        <div class="btn-group">
	                          ...
	                          <c:if test="${!contact.seen}">
		                          <a href="contact-read?id=${contact.id}" class="btn btn-info">
		                            <i class="fas fa-eye"></i>
		                          </a>
		                      </c:if>
	                          
	                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#delete-modal-${contact.id}">
						    ...
						    <div class="modal-dialog">
						      <div class="modal-content">
						        ...
						        <div class="modal-footer justify-content-between">
						          ...
						          <a href="contact-delete?id=${contact.id}" class="btn btn-danger" >Delete</a>
						        </div>
						      </div>
						      <!-- /.modal-content -->
						    </div>
