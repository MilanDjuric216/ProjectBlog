  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        ...
        <main class="col-lg-8"> 
          <div class="container">
            <form:form action="contact-save" class="commenting-form" modelAttribute="contact">
              <form:hidden path="id"/>
              <div class="row">
                <div class="form-group col-md-6">
                  <form:input path="name" type="text" placeholder="Your Name" class="form-control" required="required"/>
                </div>
                <div class="form-group col-md-6">
                  <form:input path="email" type="email" placeholder="Email Address (will not be published)" class="form-control" required="required"/>
                </div>
                <div class="form-group col-md-12">
                  <form:textarea path="message" placeholder="Type your message" class="form-control" rows="20" required="required"></form:textarea>
                </div>
                <div class="form-group col-md-12">
