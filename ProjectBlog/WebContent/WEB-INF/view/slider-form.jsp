        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form:form role="form" modelAttribute="slider" action="slider-save">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      <form:hidden path="id"/>
                      ...
                      <div class="form-group">
                        ...
                        <form:input path="buttonTitle" type="text" class="form-control" placeholder="Enter title.." required="required"/>
                      </div>
                      
                      <div class="form-group">
                        <label>Button url</label>
                        <form:input path="buttonUrl" type="text" class="form-control" placeholder="Enter picture.." required="required"/>
                      </div>
